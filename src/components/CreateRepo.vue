        ...
        <div class="details-contain7">
          ...
          <div class="modal-body">
            <form @submit.prevent="handleSubmit">
              ...
              <div class="form-control">
                <label class="private">
                  <input type="checkbox" v-model="repoDetails.private" />
                  Private Repository
                </label>
              </div>
              <div class="modal-footer">
                <button type="submit" class="save1">Create Repo</button>
                <button type="button" class="cancel1" @click="onClose">
                  Cancel
                </button>
              </div>
            </form>
...
const handleSubmit = async () => {
  const data = {
    ...
    customLanguage:
      repoDetails.language === "Other" ? repoDetails.customLanguage : undefined,
